...
def fetch_with_retry(func, max_attempts=3, delay=1):
    """Bouclier anti-crash : Réessaie automatiquement si Yahoo/INSEE bloque."""
...
def recuperer_inflation_france():
    def _fetch():
        ...
        # Fallback de sécurité (Banque Mondiale) si l'INSEE est planté
